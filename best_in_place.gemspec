...
Gem::Specification.new do |s|
  ...
  s.email       = ["joergen.dahlke@googlemail.com"]
  s.homepage    = "http://github.com/jdahlke/best_in_place"
  s.summary     = %q{Forked from http://github.com/bernat/best_in_place: It makes any field in place editable by clicking on it, it works for inputs, textareas, select dropdowns and checkboxes}
